...
async function fetchSyllabusData(url = 'ShowSyllabus.jsp?snum=305082&code=23885') {
  ...
  res.remarks = res.remarks.replace(/因應疫情發展，本學期教學及授課方式請依照學校網頁所公布之訊息為準：\n/, '')
